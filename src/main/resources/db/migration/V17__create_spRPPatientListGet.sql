USE [ResultsPortal]
GO
/****** Object:  StoredProcedure [dbo].[spRPPatientListGet]    Script Date: 4/3/2019 10:50:15 AM ******/
SET ANSI_NULLS ON
GO
	...
	;WITH ResultsCTE AS
		...
		FROM RS.dbo.tblPatient (NOLOCK)  Patient
			...
			INNER JOIN RS.dbo.tblRequisition (NOLOCK) Requisition  ON ( Requisition.vchRequisitionUrn NOT LIKE '%J'
																		...
																		AND (@vchRequisitionNumber='' OR Requisition.vchRequisitionNumber = @vchRequisitionNumber)
