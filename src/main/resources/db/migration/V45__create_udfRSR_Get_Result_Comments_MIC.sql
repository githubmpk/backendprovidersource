...
IF OBJECT_ID('dbo.udfRSR_Get_Result_Comments_MIC') IS NOT NULL
BEGIN
	DROP FUNCTION dbo.udfRSR_Get_Result_Comments_MIC
	IF OBJECT_ID('dbo.udfRSR_Get_Result_Comments_MIC') IS NOT NULL PRINT 'Failed to drop sp!!!' ELSE PRINT 'Dropped'
END
GO


/****** Object:  UserDefinedFunction [dbo].[udfRSR_Get_Result_Comments_MIC]    Script Date: 5/22/2019 10:43:15 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE FUNCTION [dbo].[udfRSR_Get_Result_Comments_MIC] (@ResId BIGINT,@Type INT)
...
SET @OutComm = ''
 ...
 DECLARE c1 CURSOR FOR
   		SELECT DISTINCT TOP 9999999 siOrder, CONCAT('          ',ResultComment.vchComment)+CHAR(10)
